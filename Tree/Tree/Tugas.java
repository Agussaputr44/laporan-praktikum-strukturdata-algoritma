 ...
 * Setiap simpul memiliki data, referensi ke simpul kiri, dan referensi ke simpul kanan.
...
/**
 * Kelas Tugas merupakan program Java yang mengimplementasikan berbagai fungsi terkait
 * dengan pohon biner, seperti pencetakan struktur pohon, traversal pre-order, in-order,
 * post-order, dan level-order.
 *
 * <p>
 * Kelas ini dibuat oleh Agus Saputra dan berfungsi sebagai program utama yang menjalankan
...
public class Tugas {
    ...
    /**
     * Metode printTree digunakan untuk mencetak struktur pohon secara rekursif dengan
