 ...
 * dengan beberapa operasi seperti penambahan simpul, penambahan anak, dan traversals.
 *
 * <p>
 * Kelas ini dibuat oleh Agus Saputra dan digunakan untuk merepresentasikan struktur pohon biner.
 * Pohon ini dapat digunakan untuk menyimpan data dan melakukan operasi seperti penambahan simpul,
 * penambahan anak pada simpul yang sudah ada, serta traversals (pre-order, in-order, post-order, level-order).
 * </p>
 *
 * <p>
...
public class BinarySearchTree {
    ...
    /**
     * Metode tambahNode digunakan untuk menambahkan simpul baru ke dalam pohon biner pencarian.
     *
    ...
    /**
     * Metode tambahNodeHelp merupakan metode rekursif yang membantu dalam penambahan simpul baru.
     *
    ...
    /**
     * Metode tambahChild digunakan untuk menambahkan anak ke simpul yang sudah ada dalam pohon.
     *
    ...
    /**
     * Metode tambahChildHelp merupakan metode rekursif yang membantu dalam penambahan anak ke simpul yang sudah ada.
     *
     * @param root         Akar saat ini dari pohon.
     * @param existingData Data pada simpul yang sudah ada.
     * @param newData      Data untuk anak baru (String).
    ...
    /**
     * Metode displayTree digunakan untuk menampilkan struktur pohon secara rekursif.
     *
     * @param root   Akar saat ini dari pohon.
