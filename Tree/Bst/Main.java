...
/**
 * Kelas Main merupakan kelas utama untuk menjalankan program dan menguji fungsionalitas dari BinarySearchTree.
 *
 * <p>
 * Kelas ini dibuat oleh Agus Saputra dan berfungsi sebagai entry point dari program.
 * Program ini melakukan pengujian operasi pohon biner pencarian seperti penambahan simpul,
 * penambahan anak pada simpul yang sudah ada, dan melakukan traversals (in-order, pre-order, post-order, level-order).
 * </p>
 *
 * @author Agus Saputra
 */
public class Main {
    ...
    /**
     * Metode main adalah entry point dari program yang membuat objek BinarySearchTree,
     * menambahkan beberapa node ke dalam pohon biner pencarian, menampilkan struktur
