...
/**
 * Kelas KruskalGraphTraversal mengimplementasikan algoritma Kruskal untuk mencari Minimum Spanning Tree (MST).
 * Algoritma ini menggunakan struktur data Union-Find untuk menangani penyatuan dan pencarian set.
 *
 * Author: [Nama Penulis]
 */
public class KruskalGraphTraversal {
    ...
    /**
     * Metode untuk menambahkan sisi ke dalam graf.
     *
     * @param source      Node sumber sisi.
     * @param destination Node tujuan sisi.
     * @param weight      Bobot sisi.
     ...
     *
     * @param node Node yang dicari representasinya.
     * @return Representasi set dari node.
     */
    ...
    /**
     * Metode main untuk menjalankan algoritma dan menguji fungsionalitas graf menggunakan algoritma Kruskal.
     *
